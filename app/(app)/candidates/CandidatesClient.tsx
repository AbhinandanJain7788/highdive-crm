...
// The nine values `application_status` actually holds — the full set the UI now offers.
// `not_eligible` (no backing enum value) was dropped from the UI in Phase 4's cleanup
// rather than extending the live enum. See claude.md's Phase 4 As-Built Notes.
